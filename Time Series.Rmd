...
Das Objet Q.z kann über dygraph TimeSeries weiterverarbeitet werde.
```{r}
library(dygraphs)
dygraph(Q.z) %>%
  dyRangeSelector() %>%
...
##References
Weiterführende Information zu dygraph findet sich unter <http://rstudio.github.io/dygraphs/index.html>.
